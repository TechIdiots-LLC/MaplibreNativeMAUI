#if WINDOWS
/**
 * HiddenWglContext.Windows.cs — off-screen WGL context for the MAUI Windows map renderer.
 *
 ...
 *
 * Kept in sync with the WPF twin: wpf/HiddenWglContext.cs.
 */
...
/// that window; call <see cref="ReadPixels"/> after each <c>MlnFrontend.Render</c> to copy the
