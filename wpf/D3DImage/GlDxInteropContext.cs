/**
 * GlDxInteropContext.cs — off-screen WGL context for the airspace-free WPF map renderer.
 *
 ...
 *
 * This replaces the earlier D3DImage / WGL_NV_DX_interop2 design which failed because
 * WGLRenderableResource::bind() in platform_frontend_windows.cpp unconditionally calls
 * glBindFramebuffer(0), so MapLibre's output always lands in FBO 0 — not in any custom
 * FBO we might create.  The glReadPixels approach requires no native rebuild.
 */
